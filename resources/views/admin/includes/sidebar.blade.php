    ...
    <div class="app-sidebar">
        <div class="side-header">
            <a class="header-brand1" href="{{ route('dashboard') }}">
                <img src="{{ asset($companyInfo->logo_jpg) }}" class="header-brand-img desktop-logo" alt="logo">
                <img src="{{ asset($companyInfo->logo_jpg) }}" class="header-brand-img toggle-logo" alt="logo">
                <img src="{{ asset($companyInfo->logo_jpg) }}" class="header-brand-img light-logo" alt="logo">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">
                            Product Attribute</span><i class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
