            ...
            <div class="row row-gap-4">
                <div class="col-xl-6">
                    <div class="account account-1">
                        ...
                        <form action="https://uiparadox.co.uk/templates/gadgetize/shop-list-1.html" method="post"
                            class="contact-form">
                            <div class="row">
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-block mb-16">
                                        <input type="email" name="mail" autocomplete="off" class="form-control"
                    ...
                    <div class="account">
                        ...
                        <form action="https://uiparadox.co.uk/templates/gadgetize/shop-list-1.html" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <p class="light-gray mb-24">Your personal information helps improve your experience on
                                        our site, manage your account, and fulfill other purposes
