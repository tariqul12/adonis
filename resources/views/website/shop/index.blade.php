                                        ...
                                        <li class="checkbox-group">
                                            <div
                                                ...
                                                <div class="check-block">
                                                    ...
                                                    <input type="checkbox" id="cable-check-{{ $loop->index }}"
                                                        class="sub-check-box" data-category-id="{{ $category->id }}">
                                    ...
                                    <a href="{{ route('product-detail', $product->id) }}"
                                        ...
                                        <div>
                                            ...
                                            <p class="color-primary"><span
                                                    class="light-gray text-decoration-line-through">TK:
                                                    {{ $product->regular_price }}</span>&nbsp;TK:
